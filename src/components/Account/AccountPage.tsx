...
import MpesaWithdrawButton from '../MpesaWithdrawButton';
...
const AccountPage: React.FC = () => {
  ...
  // Note: Direct withdrawal handling has been replaced with the PayHero iframe implementation
      ...
      <div className="bg-gradient-to-br from-green-400 to-emerald-600 text-white p-4 sm:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-8">
            ...
            <MpesaWithdrawButton className="w-full sm:w-auto px-4 py-3 sm:px-6 sm:py-3 rounded-xl font-medium
